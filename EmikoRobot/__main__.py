...
PM_START_TEXT = """
*Hello {} !*
✪ I'm an 𝑴𝑰𝒀𝑨𝑩𝑰 management bot [✨](https://telegra.ph/file/d1202e40d617afc07330c.jpg)
────────────────────────
× *Uptime:* `{}`
× `{}` *users, across* `{}` *chats.*
────────────────────────
...
DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project by contacting @nguyenzet \
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    ...
                    InlineKeyboardButton(text="Updates", url="https://t.me/RuangTerbukaa"),
                 ],
                 [
                    InlineKeyboardButton(text="Go Back", callback_data="emiko_"),
